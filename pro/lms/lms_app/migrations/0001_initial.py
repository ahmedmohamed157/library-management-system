    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pages', models.ImageField(blank=True, null=True, upload_to='')),
                ...
                ('status', models.CharField(blank=True, choices=[('available', 'available'), ('rental', 'rental'), ('solid', 'solid')], max_length=50, null=True)),
